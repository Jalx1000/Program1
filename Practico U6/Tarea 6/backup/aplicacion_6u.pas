...
uses
  Classes, SysUtils, dialogs,ArchivoFicheroU,cadenas;
 ...
 type
   ...
   texto=class
    ...
    public
      ...
      function LeerRealesArchivoFichero():ArchivoReal;
...
function texto.LeerRealesArchivoFichero(): ArchivoReal;
var s:string;
    FReal:archivoReal;
    Raux:real;
begin
   Freal:=archivoreal.create;
    Freal.setnom('Numeros reales');
    Freal.SetExt('dat');
