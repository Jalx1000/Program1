...
type
  ...
  TForm1 = class(TForm)
    ...
    procedure UsarTecladoClick(Sender: TObject);
...
procedure TForm1.Nivel1Click(Sender: TObject);
begin
  J:=Juego.Crear(Lab);
  J.CrearLab(1,fil,col);
end;
...
procedure TForm1.UsarTecladoClick(Sender: TObject);
begin
